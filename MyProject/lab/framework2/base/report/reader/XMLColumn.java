...
public class XMLColumn {
	...
	private void initialize(final int index2, final int span2, final double width2) {
		this.index = index2;
		// スパン.
		this.span = span2;
		// 列幅.
	...
	public XMLColumn(final Node columnNode, final int index, final double defaultWidth) {
		...
		// インデックス.
		this.index = (this.parseInt(columnElement.getAttribute(XMLConstants.ATTR_INDEX), index));
		// スパン.
		this.span = (this.parseInt(columnElement.getAttribute(XMLConstants.ATTR_SPAN), 0));
		// 列幅.
		this.width = (this.parseDouble(columnElement.getAttribute(XMLConstants.ATTR_WIDTH), defaultWidth));
		// スタイルID.
