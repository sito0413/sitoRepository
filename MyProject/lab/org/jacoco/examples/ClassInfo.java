...
public final class ClassInfo implements ICoverageVisitor {
	...
	public void visitCoverage(final IClassCoverage coverage) {
		...
		out.printf("instructions: %s%n", Integer.valueOf(coverage.getInstructionCounter().getTotalCount()));
		...
		out.printf("complexity:   %s%n%n", Integer.valueOf(coverage.getComplexityCounter().getTotalCount()));
	}
	...
	public static void main(final String[] args) throws IOException {
		new ClassInfo(System.out)
		        .execute("C:\\Users\\t-setani\\git\\sitoRepository\\MyProject\\classes\\frameWork\\SrcUtil.class");
	}
}
