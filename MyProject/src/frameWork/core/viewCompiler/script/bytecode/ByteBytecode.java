...
public class ByteBytecode implements InstanceBytecode {
	byte value;
	
	public ByteBytecode(final byte value) {
		this.value = value;
	}
	...
	@Override
	public ByteBytecode prefixIncrement() {
		value++;
		return this;
	}
	
	@Override
	public ByteBytecode prefixDecrement() {
		value--;
		return this;
	}
	
	@Override
	public ByteBytecode postfixIncrement() {
		final ByteBytecode bytecode = new ByteBytecode(value);
		value++;
		return bytecode;
	}
	
	@Override
	public ByteBytecode postfixDecrement() {
		final ByteBytecode bytecode = new ByteBytecode(value);
		value--;
		return bytecode;
	}
