...
public class ShortBytecode implements InstanceBytecode {
	private short value;
	
	public ShortBytecode(final short value) {
		this.value = value;
	}
	...
	@Override
	public ShortBytecode prefixIncrement() {
		value++;
		return this;
	}
	
	@Override
	public ShortBytecode prefixDecrement() {
		value--;
		return this;
	}
	
	@Override
	public ShortBytecode postfixIncrement() {
		final ShortBytecode bytecode = new ShortBytecode(value);
		value++;
		return bytecode;
	}
	
	@Override
	public ShortBytecode postfixDecrement() {
		final ShortBytecode bytecode = new ShortBytecode(value);
		value--;
		return bytecode;
	}
